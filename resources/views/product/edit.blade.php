        ...
        <form action="{{route('product.update', $product->id)}}" enctype="multipart/form-data" method="post">
            ...
            <div class="w-full mt-5">
                ...
                <div class="flex flex-col gap-1 mt-2">
                    ...
                    <input id="price" name="price" type="number" value="{{old('price', $product->price)}}" required placeholder="Masukkan Harga Maksimal" class="w-full p-1 pl-2 rounded border border-gray-300" />
                </div>
                <div class="flex flex-col gap-1 mt-2">
                    <label for="min_price">Harga Minimal (Rp)</label>
                    <input id="min_price" name="min_price" type="number" value="{{old('min_price', $product->min_price)}}" required placeholder="Masukkan Harga Minimal" class="w-full p-1 pl-2 rounded border border-gray-300" />
                </div>
                <div class="flex flex-col gap-1 mt-2">
