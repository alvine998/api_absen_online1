...
<div class="flex justify-center items-center mt-[50px] px-10">
    <div class="bg-white shadow w-full rounded-md p-4">
        <h2 class="font-semibold text-xl">Tambah Data Lokasi Toko</h2>
        <form action="{{route('storelocation.store')}}" enctype="multipart/form-data" method="post">
            @csrf
            <div class="w-full mt-5">
                ...
                <div class="flex flex-col gap-1 mt-2">
                    ...
                    <input id="long" name="long" value="{{old('long')}}" type="text" placeholder="Masukkan Longitude" class="w-full p-1 pl-2 rounded border border-gray-300" />
                </div>
                <div class="flex flex-col gap-1 mt-2">
                    <label for="radius">Radius</label>
                    <input id="radius" name="radius" value="{{old('radius')}}" type="number" placeholder="Masukkan Radius" class="w-full p-1 pl-2 rounded border border-gray-300" />
                </div>
            </div>
